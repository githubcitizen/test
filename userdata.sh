...
CHEF_SERVER_NAME="spring" # The name of your Chef Server
CHEF_SERVER_ENDPOINT="spring-zc1kjqyrihxuxgo6.us-west-2.opsworks-cm.io" # The FQDN of your Chef Server
